@echo off
REM ============================================================
REM tunel_dvr_natura.bat — Túnel SSH permanente DVR Natura
REM Sucursal: Natura | cod_sucursal: 13
REM Puerto VPS RTSP: 9583
REM DVR IP local: 192.168.1.130 (actualiza si cambia)
REM ============================================================
REM
REM INSTALACIÓN:
REM 1. Coloca este archivo en C:\tunel_dvr_natura.bat
